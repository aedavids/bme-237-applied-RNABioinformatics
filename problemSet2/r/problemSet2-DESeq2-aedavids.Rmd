...
```{r}
dataDir <- "/Users/andrewdavidson/googleUCSC/bme-237-appliedRNABioinformatics/homework/problemSet2/htseq-count.out/"
sampleFilesList <- list.files(dataDir)
sampleFilesList
```
...
res[genes_of_interest,][,c("log2FoldChange", "padj")]
```
